...
public class FuncionarioDTO {
    ...
    public FuncionarioDTO(String id, String nomeFuncionario, String cpf, String senha, String endereco, String telefone, String escolaridade, StatusPerfilEnum statusPerfil) {
        this.id = id;
